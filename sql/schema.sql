...
CREATE TABLE IF NOT EXISTS `wallet`.`wallet` (
  ...
  `virtual_credit` DECIMAL(16,9) NOT NULL,
  PRIMARY KEY (`hash`),
...
CREATE TABLE IF NOT EXISTS `wallet`.`transaction` (
  `type` INT NOT NULL COMMENT '1 for withdraw, 2 for deposit',
  `hash` VARCHAR(70) NOT NULL,
...
-- -----------------------------------------------------
-- Table `wallet`.`bet_transaction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wallet`.`bet_transaction` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `amount` DECIMAL(16,9) NOT NULL,
  `bet_type` INT NOT NULL COMMENT '1 for payIn, 2 for payOut',
  `wallet_hash` VARCHAR(70) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_bet_transaction_wallet1_idx` (`wallet_hash` ASC) VISIBLE,
  CONSTRAINT `fk_bet_transaction_wallet1`
    FOREIGN KEY (`wallet_hash`)
    REFERENCES `wallet`.`wallet` (`hash`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
